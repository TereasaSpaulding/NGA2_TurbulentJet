...
module simulation
    ...
    use lpt_react_class,   only: lptreact
    use partmesh_class,    only: partmesh
    implicit none
    private
    
    !> LPT Solver
    type(lptreact),         public :: lp
    ...
    !real(WP), dimension(:,:,:), allocatable :: fluidTemp           !< Temperature of the flow
 ...
 contains
    ...
    subroutine simulation_init
       ...
       !   do i=1,lp%np_
       !      pmesh%var(1,i)=lp%p(i)%temperature
       !   end do
